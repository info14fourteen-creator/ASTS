...
const routeChecks = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      "80-point plan",
      "Next increments",
      "Добавить AI review shared fixture",
      "Добавить source receipt docs link browser assertion",
      "Добавить source owner receipt fixture schema",
      "Добавить FNS connector fixture schema",
      "asts-app-site-ru-12",
      "19 static routes",
      "Partner quickstart",

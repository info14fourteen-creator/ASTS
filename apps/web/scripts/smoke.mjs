...
const routeChecks = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      "80-point plan",
      "Next increments",
      "Добавить source owner receipt API contract",
      "Добавить source receipt browser loop",
      "Добавить FNS network gate browser loop",
      "Добавить AI review receipt browser loop",
      "asts-app-site-ru-12",
      "19 static routes",
      "Partner quickstart",

...
const routeChecks = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      "80-point plan",
      "Next increments",
      "Добавить schema docs README live route gate note",

...
const routeChecks = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      "80-point plan",
      "Next increments",
      "Добавить source owner receipt history browser loop",
      "Добавить source owner receipt backend fixture",
      "Добавить FNS network gate API smoke assertion",
      "Добавить AI review receipt backend smoke assertion",
      "asts-app-site-ru-12",
      "19 static routes",
      "Partner quickstart",

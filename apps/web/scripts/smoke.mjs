...
const routeChecks = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      "80-point plan",
      "Next increments",
      "Добавить AI review API README failure copy",

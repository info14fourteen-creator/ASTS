...
const nextIncrements = [
  [
    "1",
    "Подготовить PR #17 release action items post-merge decision record approval receipt review handoff final report distribution receipt review handoff copy",
    "описать post-merge decision record approval receipt review handoff final report distribution receipt review handoff без handoff action",
  ],
];
...
const prReleaseActionItemsPostMergeDecisionRecordCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.command,
  postMergeDecisionAcceptanceSelector: "[data-testid='pr-release-action-items-post-merge-decision-acceptance-copy']",
  postMergeDecisionRecordScope: "PR #17 release action items post-merge decision record copy",
  expectedCheckGroups: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedCheckGroups,
  expectedConclusion: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedConclusion,
  expectedMergeState: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedMergeState,
  expectedPrComments: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedPrComments,
  expectedReviewDecision: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedReviewDecision,
  expectedReviews: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedReviews,
  expectedReviewThreads: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedReviewThreads,
  expectedUnresolvedThreads: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.expectedUnresolvedThreads,
  linkSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-anchor']",
  noDecisionRecordCopy:
    "Release action items post-merge decision record copy только описывает record text; decision record write, tracker mutation, event creation, status field update, audit append и owner assignment остаются отдельными owner actions",
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordCopy:
    "Release action items post-merge decision record для PR #17: после decision acceptance подготовить draft record с record owner, accepted decision, evidence packet, record boundary и audit note; пока owner action не подтвержден, decision record не записывается",
  prHref: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionAcceptanceCopy.releaseScope,
  repairTargets:
    "PR #17,release action items post-merge decision record,release action items post-merge decision acceptance,record owner,accepted decision,evidence packet,record boundary,audit note,apps/web/scripts/smoke.mjs,/plan",
  sourceMarkerSelector: "[data-testid='pr-release-action-items-post-merge-decision-acceptance-copy']",
  status: "action-items-post-merge-decision-record-draft",
  ...
  checks: [
    ["Owner", "Decision record связывает record owner, accepted decision и evidence packet"],
...
const prReleaseActionItemsPostMergeDecisionRecordApprovalCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.command,
  postMergeDecisionRecordReviewSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-review-copy']",
  postMergeDecisionRecordApprovalScope: "PR #17 release action items post-merge decision record approval copy",
  expectedCheckGroups: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedCheckGroups,
  expectedConclusion: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedConclusion,
  expectedMergeState: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedMergeState,
  expectedPrComments: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedPrComments,
  expectedReviewDecision: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedReviewDecision,
  expectedReviews: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedReviews,
  expectedReviewThreads: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedReviewThreads,
  expectedUnresolvedThreads: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.expectedUnresolvedThreads,
  linkSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-approval-anchor']",
  noApprovalActionCopy:
    "Release action items post-merge decision record approval copy только описывает approval text; approval action, review outcome write, tracker mutation, event creation, status field update и audit append остаются отдельными owner actions",
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalCopy:
    "Release action items post-merge decision record approval для PR #17: после decision record review подготовить draft approval с approval owner, reviewed record, approval criteria, approval boundary и receipt path; пока owner action не подтвержден, approval action не выполняется",
  prHref: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionRecordReviewCopy.releaseScope,
  repairTargets:
    "PR #17,release action items post-merge decision record approval,release action items post-merge decision record review,approval owner,reviewed record,approval criteria,approval boundary,receipt path,apps/web/scripts/smoke.mjs,/plan",
  sourceMarkerSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-review-copy']",
  status: "action-items-post-merge-decision-record-approval-draft",
  decisionRecordApprovalFields: [
    "approval owner",
    "reviewed record",
    "approval criteria",
    "approval boundary",
  ...
  checks: [
    ["Owner", "Decision record approval связывает approval owner, reviewed record и approval criteria"],
    ["Boundary", "Approval boundary и receipt path остаются approval text без action"],
    ["Action", "Этот copy не выполняет approval action, не пишет outcome и не меняет tracker"],
    ["Next", "Следующий шаг описывает release action items post-merge decision record approval receipt без записи receipt"],
  ],
};

const prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.command,
  postMergeDecisionRecordApprovalSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-copy']",
  postMergeDecisionRecordApprovalReceiptScope:
    "PR #17 release action items post-merge decision record approval receipt copy",
  expectedCheckGroups: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedCheckGroups,
  expectedConclusion: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedConclusion,
  expectedMergeState: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedMergeState,
  expectedPrComments: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedPrComments,
  expectedReviewDecision: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedReviewDecision,
  expectedReviews: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedReviews,
  expectedReviewThreads: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedReviewThreads,
  expectedUnresolvedThreads: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedUnresolvedThreads,
  linkSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-anchor']",
  noReceiptWriteCopy:
    "Release action items post-merge decision record approval receipt copy только описывает receipt text; receipt write, approval action, review outcome write, tracker mutation, event creation, status field update и audit append остаются отдельными owner actions",
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalReceiptCopy:
    "Release action items post-merge decision record approval receipt для PR #17: после decision record approval подготовить draft receipt с receipt owner, approved record, approval evidence, receipt boundary и review path; пока owner action не подтвержден, receipt не записывается",
  prHref: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.releaseScope,
  repairTargets:
    "PR #17,release action items post-merge decision record approval receipt,release action items post-merge decision record approval,receipt owner,approved record,approval evidence,receipt boundary,review path,apps/web/scripts/smoke.mjs,/plan",
  sourceMarkerSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-approval-copy']",
  status: "action-items-post-merge-decision-record-approval-receipt-draft",
  decisionRecordApprovalReceiptFields: [
    "receipt owner",
    "approved record",
    "approval evidence",
    "receipt boundary",
  ...
  checks: [
    ["Owner", "Decision record approval receipt связывает receipt owner, approved record и approval evidence"],
...
const prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.command,
  postMergeDecisionRecordApprovalReceiptReviewSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-copy']",
  postMergeDecisionRecordApprovalReceiptReviewHandoffScope:
    "PR #17 release action items post-merge decision record approval receipt review handoff copy",
  expectedCheckGroups: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedCheckGroups,
  expectedConclusion: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedConclusion,
  expectedMergeState: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedMergeState,
  expectedPrComments: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedPrComments,
  expectedReviewDecision: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedReviewDecision,
  expectedReviews: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedReviews,
  expectedReviewThreads: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedReviewThreads,
  expectedUnresolvedThreads: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.expectedUnresolvedThreads,
  linkSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-anchor']",
  noHandoffActionCopy:
    "Release action items post-merge decision record approval receipt review handoff copy только описывает handoff text; handoff action, review write, receipt write, tracker mutation, event creation, status field update и audit append остаются отдельными owner actions",
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalReceiptReviewHandoffCopy:
    "Release action items post-merge decision record approval receipt review handoff для PR #17: после decision record approval receipt review подготовить draft handoff с handoff owner, reviewed receipt, approval evidence summary, handoff boundary и return path; пока owner action не подтвержден, handoff action не выполняется",
  prHref: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewCopy.releaseScope,
  repairTargets:
    "PR #17,release action items post-merge decision record approval receipt review handoff,release action items post-merge decision record approval receipt review,handoff owner,reviewed receipt,approval evidence summary,handoff boundary,return path,apps/web/scripts/smoke.mjs,/plan",
  sourceMarkerSelector: "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-copy']",
  status: "action-items-post-merge-decision-record-approval-receipt-review-handoff-draft",
  decisionRecordApprovalReceiptReviewHandoffFields: [
    "handoff owner",
    "reviewed receipt",
  ...
  checks: [
    ["Owner", "Decision record approval receipt review handoff связывает handoff owner, reviewed receipt и approval evidence summary"],
...
const prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.command,
  postMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-acceptance-copy']",
  postMergeDecisionRecordApprovalReceiptReviewHandoffArchiveScope:
    "PR #17 release action items post-merge decision record approval receipt review handoff archive copy",
  expectedCheckGroups: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedCheckGroups,
  expectedConclusion: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedConclusion,
  expectedMergeState: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedMergeState,
  expectedPrComments: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedPrComments,
  expectedReviewDecision: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedReviewDecision,
  expectedReviews: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedReviews,
  expectedReviewThreads: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedReviewThreads,
  expectedUnresolvedThreads:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.expectedUnresolvedThreads,
  linkSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-archive-anchor']",
  noArchiveWriteCopy:
    "Release action items post-merge decision record approval receipt review handoff archive copy только описывает archive text; archive write, acceptance write, handoff action, review write, receipt write, tracker mutation, event creation, status field update и audit append остаются отдельными owner actions",
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalReceiptReviewHandoffArchiveCopy:
    "Release action items post-merge decision record approval receipt review handoff archive для PR #17: после decision record approval receipt review handoff acceptance подготовить draft archive с archive owner, accepted handoff, approval evidence summary, archive boundary и closeout path; пока owner action не подтвержден, archive не записывается",
  prHref: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceCopy.releaseScope,
  repairTargets:
    "PR #17,release action items post-merge decision record approval receipt review handoff archive,release action items post-merge decision record approval receipt review handoff acceptance,archive owner,accepted handoff,approval evidence summary,archive boundary,closeout path,apps/web/scripts/smoke.mjs,/plan",
  sourceMarkerSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-acceptance-copy']",
  status: "action-items-post-merge-decision-record-approval-receipt-review-handoff-archive-draft",
  decisionRecordApprovalReceiptReviewHandoffArchiveFields: [
    "archive owner",
    "accepted handoff",
    "approval evidence summary",
    "archive boundary",
  ...
  checks: [
    ...
    ["Boundary", "Archive boundary и closeout path остаются archive text без write"],
    ["Action", "Этот copy не записывает archive, не выполняет acceptance и не меняет tracker"],
    [
      "Next",
...
const prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.command,
  postMergeDecisionRecordApprovalReceiptReviewHandoffArchiveSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-archive-copy']",
  postMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutScope:
    "PR #17 release action items post-merge decision record approval receipt review handoff closeout copy",
  expectedCheckGroups: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedCheckGroups,
  expectedConclusion: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedConclusion,
  expectedMergeState: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedMergeState,
  expectedPrComments: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedPrComments,
  expectedReviewDecision: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedReviewDecision,
  expectedReviews: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedReviews,
  expectedReviewThreads: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedReviewThreads,
  expectedUnresolvedThreads:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedUnresolvedThreads,
  linkSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-closeout-anchor']",
  noCloseoutWriteCopy:
    "Release action items post-merge decision record approval receipt review handoff closeout copy только описывает closeout text; closeout write, archive write, acceptance write, handoff action, review write, receipt write, tracker mutation, event creation, status field update и audit append остаются отдельными owner actions",
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalReceiptReviewHandoffCloseoutCopy:
    "Release action items post-merge decision record approval receipt review handoff closeout для PR #17: после decision record approval receipt review handoff archive подготовить draft closeout с closeout owner, archived handoff, approval evidence summary, closeout boundary и final report path; пока owner action не подтвержден, closeout не записывается",
  prHref: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.releaseScope,
  repairTargets:
    "PR #17,release action items post-merge decision record approval receipt review handoff closeout,release action items post-merge decision record approval receipt review handoff archive,closeout owner,archived handoff,approval evidence summary,closeout boundary,final report path,apps/web/scripts/smoke.mjs,/plan",
  sourceMarkerSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-archive-copy']",
  status: "action-items-post-merge-decision-record-approval-receipt-review-handoff-closeout-draft",
  decisionRecordApprovalReceiptReviewHandoffCloseoutFields: [
    "closeout owner",
    "archived handoff",
    "approval evidence summary",
    "closeout boundary",
  ...
  checks: [
    ...
    ["Boundary", "Closeout boundary и final report path остаются closeout text без write"],
    ["Action", "Этот copy не записывает closeout, не выполняет archive и не меняет tracker"],
    [
      "Next",
...
const prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.command,
  postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-copy']",
  postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionScope:
    "PR #17 release action items post-merge decision record approval receipt review handoff final report distribution copy",
  expectedCheckGroups: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedCheckGroups,
  expectedConclusion: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedConclusion,
  expectedMergeState: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedMergeState,
  expectedPrComments: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedPrComments,
  expectedReviewDecision: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedReviewDecision,
  expectedReviews: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedReviews,
  expectedReviewThreads: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedReviewThreads,
  expectedUnresolvedThreads:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.expectedUnresolvedThreads,
  linkSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-anchor']",
  noDistributionWriteCopy:
    "Release action items post-merge decision record approval receipt review handoff final report distribution copy только описывает distribution text; distribution write, final report write, closeout write, archive write, acceptance write, handoff action, review write, receipt write, tracker mutation, event creation, status field update и audit append остаются отдельными owner actions",
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy:
    "Release action items post-merge decision record approval receipt review handoff final report distribution для PR #17: после decision record approval receipt review handoff final report подготовить draft distribution с distribution owner, final report packet, approval evidence summary, distribution boundary и receipt path; пока owner action не подтвержден, distribution не записывается",
  prHref: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportCopy.releaseScope,
  repairTargets:
    "PR #17,release action items post-merge decision record approval receipt review handoff final report distribution,release action items post-merge decision record approval receipt review handoff final report,distribution owner,final report packet,approval evidence summary,distribution boundary,receipt path,apps/web/scripts/smoke.mjs,/plan",
  sourceMarkerSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-copy']",
  status: "action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-draft",
  decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionFields: [
    "distribution owner",
    "final report packet",
    "approval evidence summary",
  ...
  checks: [
    ...
    ["Boundary", "Distribution boundary и receipt path остаются distribution text без write"],
    ["Action", "Этот copy не записывает distribution, не выполняет final report и не меняет tracker"],
    [
      "Next",
...
const prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.branch,
  baseBranch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.command,
  postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionSelector:
  ...
  postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptScope:
    "PR #17 release action items post-merge decision record approval receipt review handoff final report distribution receipt copy",
  expectedCheckGroups:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedCheckGroups,
  expectedConclusion:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedConclusion,
  expectedMergeState:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedMergeState,
  expectedPrComments:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedPrComments,
  expectedReviewDecision:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedReviewDecision,
  expectedReviews:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedReviews,
  expectedReviewThreads:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedReviewThreads,
  expectedUnresolvedThreads:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedUnresolvedThreads,
  linkSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-anchor']",
  noReceiptWriteCopy:
  ...
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy:
  ...
  prHref: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.prHref,
  releaseScope: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.releaseScope,
  repairTargets:
  ...
  sourceMarkerSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-copy']",
  status: "action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-draft",
  decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptFields: [
    "receipt owner",
    "distributed packet",
  ...
  checks: [
    ...
    ["Boundary", "Receipt boundary и review path остаются receipt text без write"],
    ["Action", "Этот copy не записывает receipt, не выполняет distribution и не меняет tracker"],
    [
      "Next",
...
const prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy = {
  route: "/plan",
  branch: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.branch,
  baseBranch:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.baseBranch,
  command: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.command,
  postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptSelector:
  ...
  postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewScope:
    "PR #17 release action items post-merge decision record approval receipt review handoff final report distribution receipt review copy",
  expectedCheckGroups:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedCheckGroups,
  expectedConclusion:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedConclusion,
  expectedMergeState:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedMergeState,
  expectedPrComments:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedPrComments,
  expectedReviewDecision:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedReviewDecision,
  expectedReviews:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedReviews,
  expectedReviewThreads:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedReviewThreads,
  expectedUnresolvedThreads:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedUnresolvedThreads,
  linkSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-review-anchor']",
  noReviewWriteCopy:
  ...
  ownerRole: "Release owner + Delivery reviewer",
  decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy:
  ...
  prHref: prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.prHref,
  releaseScope:
    prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.releaseScope,
  repairTargets:
  ...
  sourceMarkerSelector:
    "[data-testid='pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-copy']",
  status: "action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-review-draft",
  decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewFields: [
    "review owner",
    "received distribution receipt",
    "distribution evidence check",
    "review boundary",
    "handoff path",
  ],
  checks: [
    ...
    ["Boundary", "Review boundary и handoff path остаются review text без write"],
    ["Action", "Этот copy не записывает review outcome, не выполняет receipt write и не меняет tracker"],
    [
      "Next",
  ...
  return (
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        <section
          className="panel fixture-coverage-panel"
          data-base-branch={prReleaseActionItemsPostMergeDecisionRecordCopy.baseBranch}
          data-branch={prReleaseActionItemsPostMergeDecisionRecordCopy.branch}
          data-command={prReleaseActionItemsPostMergeDecisionRecordCopy.command}
          data-decision-record-copy={prReleaseActionItemsPostMergeDecisionRecordCopy.decisionRecordCopy}
          data-decision-record-fields={prReleaseActionItemsPostMergeDecisionRecordCopy.decisionRecordFields.join(",")}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedCheckGroups.join(",")}
          data-expected-conclusion={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedConclusion}
          data-expected-merge-state={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedMergeState}
          data-expected-pr-comments={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedPrComments}
          data-expected-review-decision={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedReviewDecision}
          data-expected-review-threads={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedReviewThreads}
          data-expected-reviews={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedReviews}
          data-expected-unresolved-threads={prReleaseActionItemsPostMergeDecisionRecordCopy.expectedUnresolvedThreads}
          data-link-selector={prReleaseActionItemsPostMergeDecisionRecordCopy.linkSelector}
          data-no-decision-record-copy={prReleaseActionItemsPostMergeDecisionRecordCopy.noDecisionRecordCopy}
          data-owner-role={prReleaseActionItemsPostMergeDecisionRecordCopy.ownerRole}
          data-post-merge-decision-acceptance-selector={
            prReleaseActionItemsPostMergeDecisionRecordCopy.postMergeDecisionAcceptanceSelector
          }
          data-post-merge-decision-record-scope={prReleaseActionItemsPostMergeDecisionRecordCopy.postMergeDecisionRecordScope}
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordCopy.prHref}
          data-release-scope={prReleaseActionItemsPostMergeDecisionRecordCopy.releaseScope}
          data-repair-targets={prReleaseActionItemsPostMergeDecisionRecordCopy.repairTargets}
          data-route={prReleaseActionItemsPostMergeDecisionRecordCopy.route}
          data-source-marker-selector={prReleaseActionItemsPostMergeDecisionRecordCopy.sourceMarkerSelector}
          data-status={prReleaseActionItemsPostMergeDecisionRecordCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-copy"
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">PR release action items post-merge decision record copy</p>
              <h2>Как описать post-merge decision record PR #17</h2>
            </div>
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordCopy.checks.map(([title, text]) => (
              <article className="fixture-coverage-card" key={title}>
                <span>{title}</span>
                <strong>
                  {title === "Owner"
        ...
        <section
          className="panel fixture-coverage-panel"
          data-base-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.baseBranch}
          data-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.branch}
          data-command={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.command}
          data-decision-record-approval-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.decisionRecordApprovalCopy
          }
          data-decision-record-approval-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.decisionRecordApprovalFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedConclusion}
          data-expected-merge-state={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedMergeState}
          data-expected-pr-comments={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedPrComments}
          data-expected-review-decision={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedReviewDecision}
          data-expected-review-threads={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedReviewThreads}
          data-expected-reviews={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedReviews}
          data-expected-unresolved-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.expectedUnresolvedThreads
          }
          data-link-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.linkSelector}
          data-no-approval-action-copy={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.noApprovalActionCopy}
          data-owner-role={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.ownerRole}
          data-post-merge-decision-record-approval-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.postMergeDecisionRecordApprovalScope
          }
          data-post-merge-decision-record-review-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.postMergeDecisionRecordReviewSelector
          }
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.prHref}
          data-release-scope={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.releaseScope}
          data-repair-targets={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.repairTargets}
          data-route={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.route}
          data-source-marker-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.sourceMarkerSelector}
          data-status={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-approval-copy"
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">PR release action items post-merge decision record approval copy</p>
              <h2>Как описать post-merge decision record approval PR #17</h2>
            </div>
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.checks.map(([title, text]) => (
              <article className="fixture-coverage-card" key={title}>
                <span>{title}</span>
                <strong>
                  {title === "Owner"
          ...
          <p className="stage-line muted">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalCopy.noApprovalActionCopy}
          </p>
        </section>

        <section
          className="panel fixture-coverage-panel"
          data-base-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.baseBranch}
          data-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.branch}
          data-command={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.command}
          data-decision-record-approval-receipt-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.decisionRecordApprovalReceiptCopy
          }
          data-decision-record-approval-receipt-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.decisionRecordApprovalReceiptFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedConclusion}
          data-expected-merge-state={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedMergeState}
          data-expected-pr-comments={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedPrComments}
          data-expected-review-decision={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedReviewDecision
          }
          data-expected-review-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedReviewThreads
          }
          data-expected-reviews={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedReviews}
          data-expected-unresolved-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.expectedUnresolvedThreads
          }
          data-link-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.linkSelector}
          data-no-receipt-write-copy={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.noReceiptWriteCopy}
          data-owner-role={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.ownerRole}
          data-post-merge-decision-record-approval-receipt-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.postMergeDecisionRecordApprovalReceiptScope
          }
          data-post-merge-decision-record-approval-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.postMergeDecisionRecordApprovalSelector
          }
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.prHref}
          data-release-scope={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.releaseScope}
          data-repair-targets={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.repairTargets}
          data-route={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.route}
          data-source-marker-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.sourceMarkerSelector}
          data-status={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-copy"
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">PR release action items post-merge decision record approval receipt copy</p>
              <h2>Как описать post-merge decision record approval receipt PR #17</h2>
            </div>
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptCopy.checks.map(([title, text]) => (
              <article className="fixture-coverage-card" key={title}>
                <span>{title}</span>
                <strong>
                  {title === "Owner"
        ...
        <section
          className="panel fixture-coverage-panel"
          data-base-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.baseBranch}
          data-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.branch}
          data-command={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.command}
          data-decision-record-approval-receipt-review-handoff-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.decisionRecordApprovalReceiptReviewHandoffCopy
          }
          data-decision-record-approval-receipt-review-handoff-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.decisionRecordApprovalReceiptReviewHandoffFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedConclusion}
          data-expected-merge-state={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedMergeState
          }
          data-expected-pr-comments={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedPrComments
          }
          data-expected-review-decision={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedReviewDecision
          }
          data-expected-review-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedReviewThreads
          }
          data-expected-reviews={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedReviews}
          data-expected-unresolved-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.expectedUnresolvedThreads
          }
          data-link-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.linkSelector}
          data-no-handoff-action-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.noHandoffActionCopy
          }
          data-owner-role={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.ownerRole}
          data-post-merge-decision-record-approval-receipt-review-handoff-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffScope
          }
          data-post-merge-decision-record-approval-receipt-review-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.postMergeDecisionRecordApprovalReceiptReviewSelector
          }
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.prHref}
          data-release-scope={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.releaseScope}
          data-repair-targets={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.repairTargets}
          data-route={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.route}
          data-source-marker-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.sourceMarkerSelector}
          data-status={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-copy"
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">PR release action items post-merge decision record approval receipt review handoff copy</p>
              <h2>Как описать post-merge decision record approval receipt review handoff PR #17</h2>
            </div>
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCopy.checks.map(([title, text]) => (
              <article className="fixture-coverage-card" key={title}>
                <span>{title}</span>
                <strong>
                  {title === "Owner"
        ...
        <section
          className="panel fixture-coverage-panel"
          data-base-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.baseBranch}
          data-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.branch}
          data-command={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.command}
          data-decision-record-approval-receipt-review-handoff-archive-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.decisionRecordApprovalReceiptReviewHandoffArchiveCopy
          }
          data-decision-record-approval-receipt-review-handoff-archive-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.decisionRecordApprovalReceiptReviewHandoffArchiveFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedConclusion
          }
          data-expected-merge-state={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedMergeState
          }
          data-expected-pr-comments={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedPrComments
          }
          data-expected-review-decision={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedReviewDecision
          }
          data-expected-review-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedReviewThreads
          }
          data-expected-reviews={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedReviews
          }
          data-expected-unresolved-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.expectedUnresolvedThreads
          }
          data-link-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.linkSelector}
          data-no-archive-write-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.noArchiveWriteCopy
          }
          data-owner-role={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.ownerRole}
          data-post-merge-decision-record-approval-receipt-review-handoff-acceptance-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffAcceptanceSelector
          }
          data-post-merge-decision-record-approval-receipt-review-handoff-archive-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffArchiveScope
          }
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.prHref}
          data-release-scope={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.releaseScope}
          data-repair-targets={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.repairTargets}
          data-route={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.route}
          data-source-marker-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.sourceMarkerSelector
          }
          data-status={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-archive-copy"
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">
                PR release action items post-merge decision record approval receipt review handoff archive copy
              </p>
              <h2>Как описать post-merge decision record approval receipt review handoff archive PR #17</h2>
            </div>
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-archive-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffArchiveCopy.checks.map(
              ([title, text]) => (
                <article className="fixture-coverage-card" key={title}>
                  <span>{title}</span>
                  <strong>
        ...
        <section
          className="panel fixture-coverage-panel"
          data-base-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.baseBranch}
          data-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.branch}
          data-command={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.command}
          data-decision-record-approval-receipt-review-handoff-closeout-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.decisionRecordApprovalReceiptReviewHandoffCloseoutCopy
          }
          data-decision-record-approval-receipt-review-handoff-closeout-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.decisionRecordApprovalReceiptReviewHandoffCloseoutFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedConclusion
          }
          data-expected-merge-state={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedMergeState
          }
          data-expected-pr-comments={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedPrComments
          }
          data-expected-review-decision={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedReviewDecision
          }
          data-expected-review-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedReviewThreads
          }
          data-expected-reviews={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedReviews
          }
          data-expected-unresolved-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.expectedUnresolvedThreads
          }
          data-link-selector={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.linkSelector}
          data-no-closeout-write-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.noCloseoutWriteCopy
          }
          data-owner-role={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.ownerRole}
          data-post-merge-decision-record-approval-receipt-review-handoff-archive-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffArchiveSelector
          }
          data-post-merge-decision-record-approval-receipt-review-handoff-closeout-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutScope
          }
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.prHref}
          data-release-scope={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.releaseScope}
          data-repair-targets={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.repairTargets}
          data-route={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.route}
          data-source-marker-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.sourceMarkerSelector
          }
          data-status={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-closeout-copy"
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">
                PR release action items post-merge decision record approval receipt review handoff closeout copy
              </p>
              <h2>Как описать post-merge decision record approval receipt review handoff closeout PR #17</h2>
            </div>
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-closeout-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffCloseoutCopy.checks.map(
              ([title, text]) => (
                <article className="fixture-coverage-card" key={title}>
                  <span>{title}</span>
                  <strong>
        ...
        <section
          className="panel fixture-coverage-panel"
          data-base-branch={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.baseBranch
          }
          data-branch={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.branch}
          data-command={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.command
          }
          data-decision-record-approval-receipt-review-handoff-final-report-distribution-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy
          }
          data-decision-record-approval-receipt-review-handoff-final-report-distribution-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.expectedConclusion
          ...
          data-link-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.linkSelector
          }
          data-no-distribution-write-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.noDistributionWriteCopy
          }
          data-owner-role={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.ownerRole}
          data-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionScope
          }
          data-post-merge-decision-record-approval-receipt-review-handoff-final-report-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportSelector
          }
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.prHref}
          data-release-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.releaseScope
          }
          data-repair-targets={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.repairTargets
          }
          data-route={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.route}
          data-source-marker-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.sourceMarkerSelector
          }
          data-status={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-copy"
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">
                PR release action items post-merge decision record approval receipt review handoff final report distribution copy
              </p>
              <h2>
            ...
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionCopy.checks.map(
              ([title, text]) => (
                <article className="fixture-coverage-card" key={title}>
                  <span>{title}</span>
                  <strong>
        ...
        <section
          ...
          data-branch={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.branch
          }
          data-command={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.command
          }
          data-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy
          }
          data-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.expectedConclusion
          ...
          data-link-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.linkSelector
          }
          data-no-receipt-write-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.noReceiptWriteCopy
          }
          data-owner-role={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.ownerRole
          }
          data-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptScope
          }
          data-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionSelector
          }
          data-pr-href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.prHref}
          data-release-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.releaseScope
          }
          data-repair-targets={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.repairTargets
          }
          data-route={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.route}
          data-source-marker-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.sourceMarkerSelector
          }
          data-status={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.status}
          data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-copy"
        >
          <div className="panel-head compact">
            <div>
            ...
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptCopy.checks.map(
              ([title, text]) => (
                <article className="fixture-coverage-card" key={title}>
                  <span>{title}</span>
                  <strong>
        ...
        <section
          className="panel fixture-coverage-panel"
          data-base-branch={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.baseBranch
          }
          data-branch={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.branch
          }
          data-command={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.command
          }
          data-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-review-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy
          }
          data-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-review-fields={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.decisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewFields.join(
            ",",
          )}
          data-expected-check-groups={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedCheckGroups.join(
            ",",
          )}
          data-expected-conclusion={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedConclusion
          }
          data-expected-merge-state={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedMergeState
          }
          data-expected-pr-comments={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedPrComments
          }
          data-expected-review-decision={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedReviewDecision
          }
          data-expected-review-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedReviewThreads
          }
          data-expected-reviews={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedReviews
          }
          data-expected-unresolved-threads={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.expectedUnresolvedThreads
          }
          data-link-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.linkSelector
          }
          data-no-review-write-copy={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.noReviewWriteCopy
          }
          data-owner-role={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.ownerRole
          }
          data-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-review-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewScope
          }
          data-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.postMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptSelector
          }
          data-pr-href={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.prHref
          }
          data-release-scope={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.releaseScope
          }
          data-repair-targets={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.repairTargets
          }
          data-route={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.route
          }
          data-source-marker-selector={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.sourceMarkerSelector
          }
          data-status={
            prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.status
          }
        ...
        >
          <div className="panel-head compact">
            <div>
              <p className="eyebrow">
                PR release action items post-merge decision record approval receipt review handoff final report
                distribution receipt review copy
              </p>
              <h2>
                Как описать post-merge decision record approval receipt review handoff final report distribution receipt
                review PR #17
            ...
            <a
              className="primary-link"
              data-testid="pr-release-action-items-post-merge-decision-record-approval-receipt-review-handoff-final-report-distribution-receipt-review-anchor"
              href={prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.prHref}
            >
              PR #17
            </a>
          </div>
          <div className="fixture-coverage-grid">
            {prReleaseActionItemsPostMergeDecisionRecordApprovalReceiptReviewHandoffFinalReportDistributionReceiptReviewCopy.checks.map(
              ([title, text]) => (
                <article className="fixture-coverage-card" key={title}>
                  <span>{title}</span>
                  <strong>

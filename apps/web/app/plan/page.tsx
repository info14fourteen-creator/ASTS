...
const nextIncrements = [
  ["1", "Добавить AI review queue README workflow docs final QA copy", "закрепить AI queue README workflow docs final QA handoff"],
  ["2", "Добавить shared validation README workflow docs final QA copy", "закрепить shared validation README workflow docs final QA handoff"],
  ["3", "Добавить web build README workflow docs final QA copy", "закрепить Web build README workflow docs final QA handoff"],
  ["4", "Добавить source connectors README workflow docs owner handoff copy", "закрепить Source Connectors README workflow docs owner handoff"],
];

...
const nextIncrements = [
  [
    "1",
    "Подготовить PR #17 release action items post-merge decision record approval receipt copy",
    "описать post-merge decision record approval receipt без записи receipt",
  ],
];

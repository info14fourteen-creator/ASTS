...
const nextIncrements = [
  ["1", "Добавить source owner receipt backend fixture", "связать history seed с /v1/sources/owner-receipts"],
  ["2", "Добавить FNS network gate API smoke assertion", "проверить docs link и Legal gate в web smoke"],
  ["3", "Добавить AI review receipt backend smoke assertion", "закрепить /v1/ai/review-queue link в web smoke"],
  ["4", "Добавить source owner receipt API smoke assertion", "закрепить history loop и backend contract в web smoke"],
];
